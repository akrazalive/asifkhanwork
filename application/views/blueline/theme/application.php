...
<head>
    ...
    <link rel="shortcut icon" href="<?=base_url()?>assets/blueline/img/favicon.png" />

    <title>DTSys | Sistema Administrativo</title>
    ...
    <div class="side">
        ...
        <div class="sidebar">
            <div class="navbar-header" style="background-color: white;">
                <a class="navbar-brand" href="#"><img src="<?=base_url()?>assets/blueline/img/logo-crm.gif" alt="Sistema Administrativo DTSys"></a>
            </div>
            <ul class="nav nav-sidebar">
                ...
                if (is_array($menu) || is_object($menu)) {
                    foreach ($menu as $key => $value) {
                        ...
                        <span class="menu-icon"><i class="fa <?=$value->icon; ?>"></i></span>
                        <span class="nav-text">
